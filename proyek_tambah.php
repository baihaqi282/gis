...
<div class="row">
    <div class="col-sm-6">
        ...
        <form method="post" action="?m=proyek_tambah" enctype="multipart/form-data">
		<div class="col-sm-12">
		...
		<div class="col-sm-12">
			...
			<div class="col-sm-5">
                ...
                <span class="text-justify"><input class="form-control" onclick="hitungtotal()" type="text" name="waktu" id="waktu" value="<?=$_POST[waktu]?> "/> 
				</div>
				<div class="col-sm-3">
				<br>
				<br>
