<?php
	...
	$rowtempat = $db->get_row("SELECT * FROM tb_tempat WHERE id_tempat='$rowproyek->id_tempat'");
?>
...
<div class="row">
    <div class="col-sm-6">
        ...
        <form method="post" action="?m=proyek_ubah_list&IDP=<?=$rowproyek->id_proyek?>" enctype="multipart/form-data">
          <div class="col-sm-12">
            <div class="form-group">
                <label>Daftar Tempat <span class="text-danger">*</span></label>
                <select class="form-control" name="id_tempat" Readonly>
                   <?=get_tempat_option($rowproyek->id_tempat)?>
                </select>
		...
		<div class="col-sm-12">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kontrak" value="<?=$rowproyek->kontrak?>"/>
            </div>
		</div>
		...
		<div class="col-sm-12">		
			<div class="form-group">
                ...
                <input class="form-control" type="text" name="kegiatan" value="<?=$rowproyek->kegiatan?>"/>
            </div>
		</div>
		...
		<div class="col-sm-12">
			<div class="form-group">
                ...
                <input class="form-control" type="text" name="pekerjaan" value="<?=$rowproyek->pekerjaan?>"/>
            </div>
		</div>	
			...
			<div class="form-group">
					<label>Tanggal Awal Pelaksanaan <span class="text-danger">*</span></label>
			         <div class='input-group date' id='tglawal'>
						 <input class="form-control" type="text" name="awal" value="<?=$rowproyek->awal?>"/>
			...
			<div class="form-group">
					<label>Tanggal Akhir Pekerjaaan <span class="text-danger">*</span></label>
			         <div class='input-group date' id='tglakhir'  >
						 <input class="form-control" type="text" name="akhir" value="<?=$rowproyek->akhir?>"/>
						 <span class="input-group-addon">
						 <span class="glyphicon glyphicon-calendar"></span>
						 </span>
					</div>
			...
			<div class="col-sm-5">
                ...
                <span class="text-justify"><input class="form-control" type="text" placeholder="Masukkan Anggaran" onkeyup="convertToRupiah(this);" name="biaya" value="<?=$rowproyek->biaya?>"/>
            </div>
	 
				<div class="col-sm-3">
				<label> Waktu <span class="text-danger">*</span></label>
                <span class="text-justify"><input class="form-control" onclick="hitungtotal()" type="text" name="waktu" id="waktu" Readonly value="<?=$rowproyek->waktu?>"/> 
				</div>
				<div class="col-sm-3">
				<br>
				<br>
			...
			<br>
                ...
                <input class="form-control" type="text" name="pelaksana" value="<?=$rowproyek->pelaksana?>"/>
            </div>
			</div>	
			...
			<div class="form-group">
                ...
                <input class="form-control" type="text" name="pengawas" value="<?=$rowproyek->pengawas?>"/>
            </div>
			</div>
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger" href="?m=proyek_list&IDT=<?=$rowproyek->id_tempat?>"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
