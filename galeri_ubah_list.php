...
<div class="row">
    <div class="col-sm-6">
        ...
        <form method="post" action="?m=galeri_ubah_list&IDG=<?=$rowgaleri->id_galeri?>" enctype="multipart/form-data">
			<div class="col-sm-12">
				<div class="form-group">
					<label>Daftar Tempat <span class="text-danger">*</span></label>
					<select class="form-control" name="id_tempat" Readonly value=" <?=get_tempat_option($rowtempat->id_tempat)?>" >
		 ...
		 <div class="col-sm-12">		
			<div class="form-group">
                ...
                <select class="form-control" name="id_proyek" Readonly value="<?=get_proyek_option($rowproyek->id_proyek)?>" >
		...
		<div class="col-sm-12">	
			...
			<div class="form-group">
					...
					<div class="col-sm-2"><br>
					   <input class="form-control" type="text" name="proses" id="proses" Readonly value="<?=$rowgaleri->proses?>"/>
					</div>
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger" href="?m=galeri_list&IDT=<?=$rowtempat->id_tempat?>&IDP=<?=$rowproyek->id_proyek?>"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
            </div>
			</div>
        </form>
    </div>
