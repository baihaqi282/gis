...
<div class="row">
    <div class="col-sm-7">
        ...
        <form method="post" action="?m=galeri_tambah_list" enctype="multipart/form-data">
            ...
            <div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-2"><br>
					   <input class="form-control" type="text" name="proses" id="proses" Readonly value="<?=$_POST[proses]?>"/>
					</div>
