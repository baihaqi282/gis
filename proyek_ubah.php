<?php
    $rowp = $db->get_row("SELECT * FROM tb_proyek WHERE id_proyek='$_GET[IDP]'"); 
?>
...
<div class="row">
    <div class="col-sm-6">
        ...
        <form method="post" action="?m=proyek_ubah&IDP=<?=$rowp->id_proyek?>" enctype="multipart/form-data">
          <div class="col-sm-12">
            <div class="form-group">
                <label>Daftar Tempat <span class="text-danger">*</span></label>
                <select class="form-control" name="id_tempat">
                   <?=get_tempat_option($rowp->id_tempat)?>
                </select>
            </div>
        </div>
		...
		<div class="col-sm-12">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kontrak" value="<?=$rowp->kontrak?>"/>
            </div>
		</div>
		...
		<div class="col-sm-12">		
			<div class="form-group">
                ...
                <input class="form-control" type="text" name="kegiatan" value="<?=$rowp->kegiatan?>"/>
            </div>
		</div>
		...
		<div class="col-sm-12">
			<div class="form-group">
                ...
                <input class="form-control" type="text" name="pekerjaan" value="<?=$rowp->pekerjaan?>"/>
            </div>
		</div>	
			...
			<div class="form-group">
					<label>Tanggal Awal Pelaksanaan <span class="text-danger">*</span></label>
			         <div class='input-group date' id='tglawal'>
						 <input class="form-control" type="text" name="awal" value="<?=$rowp->awal?>"/>
			...
			<div class="form-group">
					<label>Tanggal Akhir Pekerjaaan <span class="text-danger">*</span></label>
			         <div class='input-group date' id='tglakhir'  >
						 <input class="form-control" type="text" name="akhir" value="<?=$rowp->akhir?>"/>
						 <span class="input-group-addon">
						 <span class="glyphicon glyphicon-calendar"></span>
						 </span>
					</div>
			...
			<div class="col-sm-5">
                ...
                <span class="text-justify"><input class="form-control" type="text" placeholder="Masukkan Anggaran" onkeyup="convertToRupiah(this);" name="biaya" value="<?=$rowp->biaya?>"/>
            </div>
	 
				<div class="col-sm-3">
				<label> Waktu <span class="text-danger">*</span></label>
                <span class="text-justify"><input class="form-control" onclick="hitungtotal()" type="text" name="waktu" id="waktu" value="<?=$rowp->waktu?>"/> 
				</div>
				<div class="col-sm-3">
				<br>
				<br>
			...
			<br>
                ...
                <input class="form-control" type="text" name="pelaksana" value="<?=$rowp->pelaksana?>"/>
            </div>
			</div>	
			...
			<div class="form-group">
                ...
                <input class="form-control" type="text" name="pengawas" value="<?=$rowp->pengawas?>"/>
            </div>
			</div>
